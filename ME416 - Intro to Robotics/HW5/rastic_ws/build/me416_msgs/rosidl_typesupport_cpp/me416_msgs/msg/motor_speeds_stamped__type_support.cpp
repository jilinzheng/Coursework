...
static const _MotorSpeedsStamped_type_support_symbol_names_t _MotorSpeedsStamped_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, me416_msgs, msg, MotorSpeedsStamped)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, me416_msgs, msg, MotorSpeedsStamped)),
  }
};
...
{
  return &::me416_msgs::msg::rosidl_typesupport_cpp::MotorSpeedsStamped_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, me416_msgs, msg, MotorSpeedsStamped)() {
  return get_message_type_support_handle<me416_msgs::msg::MotorSpeedsStamped>();
}
