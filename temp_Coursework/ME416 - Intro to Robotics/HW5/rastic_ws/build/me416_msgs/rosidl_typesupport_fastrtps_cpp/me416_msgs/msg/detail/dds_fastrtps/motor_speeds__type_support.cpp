...
#include "me416_msgs/msg/detail/motor_speeds__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const me416_msgs::msg::MotorSpeeds & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  me416_msgs::msg::MotorSpeeds & ros_message)
{
  // Member: left
  cdr >> ros_message.left;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = me416_msgs::msg::MotorSpeeds;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const me416_msgs::msg::MotorSpeeds *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<me416_msgs::msg::MotorSpeeds *>(
    untyped_ros_message);
...
{
  return &me416_msgs::msg::typesupport_fastrtps_cpp::_MotorSpeeds__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, me416_msgs, msg, MotorSpeeds)() {
  return &me416_msgs::msg::typesupport_fastrtps_cpp::_MotorSpeeds__handle;
}
